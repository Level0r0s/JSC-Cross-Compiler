    ...
    public class MSVSProjectFile
    {
        ...
        public static MSVSProjectFile FromFile(string filepath)
        {
            ...
            Func<FileInfo, bool> HasReference =
              AssemblyFile =>
              {
                  // z:\jsc.svn\core\ScriptCoreLib.Ultra.Library\ScriptCoreLib.Ultra.Library\Ultra\Studio\MSVSProjectFile.cs
                  // https://sites.google.com/a/jsc-solutions.net/work/knowledge-base/15-dualvr/20150907/glsl
                  var TargetHintPath = GetRelativePathOrNull(
            ...
            Action<FileInfo, AssemblyName> AddReference =
                (AssemblyFile, Name) =>
                {
                    ...
                    Console.WriteLine("AddReference GetRelativePathOrNull " + new { AssemblyFile, Name });
  ...
  <HintPath>bin\staging\AutoGeneratedReferences.Components.JohDoe.TextComponent.dll</HintPath>
                    ...
                    */
                    ...
                    if (!HasReference(AssemblyFile))
                    {
                        ...
                        Console.WriteLine("AddReference " + new { TargetHintPath });
        ...
        public static string GetRelativePathOrNull(string fromPath, string toPath)
        {
            // https://sites.google.com/a/jsc-solutions.net/work/knowledge-base/15-dualvr/20150907/glsl
