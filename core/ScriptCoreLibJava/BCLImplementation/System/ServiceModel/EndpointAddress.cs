...
{
    // https://msdn.microsoft.com/en-us/library/system.servicemodel.endpointaddress(v=vs.110).aspx
    ...
    [Script(ImplementsViaAssemblyQualifiedName = "System.ServiceModel.EndpointAddress")]
    public class __EndpointAddress 
    {
