            ...
            new { }.With(
                async delegate
                {
                    ...
                    while (await refresh.async.onclick)
                    {
                        ...
                        var socket = new UdpClient(49834);

                        //script: error JSC1000: Missing Script Attribute? Native constructor was invoked, please implement[System.Net.Sockets.UdpClient..ctor(System.Int32)]
                        ...
                        while (true)
                        {
                            ...
                            new IHTMLPre { $"ReceiveAsync: {s.Buffer.Length}" }.AttachToDocument();
                            new IHTMLPre { "ReceiveAsync: " + Encoding.UTF8.GetString(s.Buffer) }.AttachToDocument();
