...
using x360videoUI;
using x360videoUI.Design;
using x360videoUI.HTML.Pages;
...
namespace x360videoUI
{
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // from red to asus
        // net use
        // subst a: s:\jsc.svn\examples\javascript\chrome\apps\x360videoUI\bin\Debug\staging\x360videoUI.Application\web
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360videoUI");
