...
namespace Chrome360LightAnimation.Models
{
    ...
    public class ColladaS6Edge : THREE_ColladaAsset
    {
        ...
        public ColladaS6Edge()
            : base(
                ...
                //http://192.168.1.199:8374/assets/Chrome360LightAnimation.Application/S6Edge.dae Failed to load resource: the server 
                "assets/Chrome360LightAnimation/S6Edge.dae"
                )
        {
