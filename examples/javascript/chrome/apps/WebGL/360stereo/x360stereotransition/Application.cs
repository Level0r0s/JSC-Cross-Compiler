...
using x360stereotransition;
using x360stereotransition.Design;
using x360stereotransition.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360stereotransition
{
    using x360stereotransition.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360stereotransition\x360stereotransition\bin\Debug\staging\x360stereotransition.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360stereotransition\x360stereotransition\bin\Debug\staging\x360stereotransition.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360stereotransition\x360stereotransition\bin\Debug\staging\x360stereotransition.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360stereotransition/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360stereotransition");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360stereotransition/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
