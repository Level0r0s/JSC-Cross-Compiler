...
using ChromeShaderToyPrograms.a;
using ChromeShaderToyPrograms.a.Design;
using ChromeShaderToyPrograms.a.HTML.Pages;
...
namespace ChromeShaderToyPrograms.a
{
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        public Application(IApp page)
        {
            ...
            //new IHTMLOption { value = "", innerText = $"{a.programs.Count} shaders available" }.AttachTo(combo);
            new IHTMLOption { value = "", innerText = a.programs.Count + " shaders available" }.AttachTo(combo);
            ...
            //Error CS0433  The type 'ShaderToy' exists in both 'ChromeShaderToyColumns, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null' and 'WebGL ShaderToy, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null'    ChromeShaderToyPrograms.a Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\ChromeShaderToyPrograms\ChromeShaderToyPrograms.a\Application.cs   283
            ...
            a.programs.Keys.WithEachIndex(
                async (key, index) =>
                {
                    //var text = (1 + index) + " of " + References.programs.Count + " " + key.SkipUntilIfAny("ChromeShaderToy").Replace("By", " by ");
                    var text = (1 + index) + " of " + a.programs.Count + " " + key.SkipUntilIfAny("ChromeShaderToy").Replace("By", " by ");
