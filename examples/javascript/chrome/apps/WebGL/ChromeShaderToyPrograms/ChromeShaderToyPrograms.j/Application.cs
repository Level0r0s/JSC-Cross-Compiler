...
using ChromeShaderToyPrograms.j;
using ChromeShaderToyPrograms.j.Design;
using ChromeShaderToyPrograms.j.HTML.Pages;
...
namespace ChromeShaderToyPrograms.j
{
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        public Application(IApp page)
        {
            ...
            new IHTMLOption { value = "", innerText = $"{j.programs.Count} shaders available" }.AttachTo(combo);
            ...
            //Error CS0433  The type 'ShaderToy' exists in both 'ChromeShaderToyColumns, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null' and 'WebGL ShaderToy, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null'    ChromeShaderToyPrograms.j Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\ChromeShaderToyPrograms\ChromeShaderToyPrograms.j\Application.cs   283
            ...
            j.programs.Keys.WithEachIndex(
                async (key, index) =>
                {
                    //var text = (1 + index) + " of " + References.programs.Count + " " + key.SkipUntilIfAny("ChromeShaderToy").Replace("By", " by ");
                    var text = (1 + index) + " of " + j.programs.Count + " " + key.SkipUntilIfAny("ChromeShaderToy").Replace("By", " by ");
