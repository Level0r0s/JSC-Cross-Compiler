...
using x360columns;
using x360columns.Design;
using x360columns.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360columns
{
    using x360columns.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360columns\x360columns\bin\Debug\staging\x360columns.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360columns\x360columns\bin\Debug\staging\x360columns.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360columns\x360columns\bin\Debug\staging\x360columns.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360columns/S6Edge.dae)
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360columns");
