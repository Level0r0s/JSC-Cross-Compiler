...
using x360postcard;
using x360postcard.Design;
using x360postcard.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360postcard
{
    //using x360postcard.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360postcard\00188.png" /sdcard/oculus/360photos/
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360postcard\x360postcard\bin\Debug\staging\x360postcard.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360postcard\x360postcard\bin\Debug\staging\x360postcard.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360postcard\x360postcard\bin\Debug\staging\x360postcard.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360postcard/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360postcard");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360postcard/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
...
// assembly: V:\x360postcard.Application.exe
// type: CubeToEquirectangular.Library.ShaderToy+<AttachToDocument>d__14+<MoveNext>06000034, x360postcard.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// offset: 0x0154
