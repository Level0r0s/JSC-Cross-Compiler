...
using x360roomscan;
using x360roomscan.Design;
using x360roomscan.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360roomscan
{
    using x360roomscan.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360roomscan\x360roomscan\bin\Debug\staging\x360roomscan.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360roomscan\x360roomscan\bin\Debug\staging\x360roomscan.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360roomscan\x360roomscan\bin\Debug\staging\x360roomscan.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360roomscan/S6Edge.dae)
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360roomscan");
