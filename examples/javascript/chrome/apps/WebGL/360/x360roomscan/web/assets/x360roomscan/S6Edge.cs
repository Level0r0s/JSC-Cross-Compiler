    ...
    public class ColladaS6Edge : THREE_ColladaAsset
    {
        ...
        public ColladaS6Edge()
            : base(
                ...
                //http://192.168.1.199:8374/assets/x360roomscan.Application/S6Edge.dae Failed to load resource: the server 
                "assets/x360roomscan/S6Edge.dae"
                )
        {
