...
using x360doomE1M1;
using x360doomE1M1.Design;
using x360doomE1M1.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360doomE1M1
{
    //using x360doomE1M1.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360doomE1M1\00188.png" /sdcard/oculus/360photos/
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360doomE1M1\x360doomE1M1\bin\Debug\staging\x360doomE1M1.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360doomE1M1\x360doomE1M1\bin\Debug\staging\x360doomE1M1.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360doomE1M1\x360doomE1M1\bin\Debug\staging\x360doomE1M1.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360doomE1M1/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360doomE1M1");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360doomE1M1/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
