...
using x360tracecone;
using x360tracecone.Design;
using x360tracecone.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360tracecone
{
    using x360tracecone.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360tracecone\x360tracecone\bin\Debug\staging\x360tracecone.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360tracecone\x360tracecone\bin\Debug\staging\x360tracecone.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360tracecone\x360tracecone\bin\Debug\staging\x360tracecone.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360tracecone/S6Edge.dae)
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360tracecone");
