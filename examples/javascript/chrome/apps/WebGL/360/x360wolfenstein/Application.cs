...
using x360wolfenstein;
using x360wolfenstein.Design;
using x360wolfenstein.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360wolfenstein
{
    //using x360wolfenstein.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360wolfenstein\00188.png" /sdcard/oculus/360photos/
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360wolfenstein\x360wolfenstein\bin\Debug\staging\x360wolfenstein.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360wolfenstein\x360wolfenstein\bin\Debug\staging\x360wolfenstein.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360wolfenstein\x360wolfenstein\bin\Debug\staging\x360wolfenstein.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360wolfenstein/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360wolfenstein");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360wolfenstein/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
...
// assembly: V:\x360wolfenstein.Application.exe
// type: CubeToEquirectangular.Library.ShaderToy+<AttachToDocument>d__14+<MoveNext>06000034, x360wolfenstein.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// offset: 0x0154
