...
using x360dottedgrid;
using x360dottedgrid.Design;
using x360dottedgrid.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360dottedgrid
{
    //using x360dottedgrid.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360dottedgrid\00188.png" /sdcard/oculus/360photos/
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360dottedgrid\x360dottedgrid\bin\Debug\staging\x360dottedgrid.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360dottedgrid\x360dottedgrid\bin\Debug\staging\x360dottedgrid.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360dottedgrid\x360dottedgrid\bin\Debug\staging\x360dottedgrid.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360dottedgrid/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360dottedgrid");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360dottedgrid/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
