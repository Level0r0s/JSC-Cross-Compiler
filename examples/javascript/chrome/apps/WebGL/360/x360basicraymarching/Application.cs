...
using x360basicraymarching;
using x360basicraymarching.Design;
using x360basicraymarching.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360basicraymarching
{
    //using x360basicraymarching.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360basicraymarching\00188.png" /sdcard/oculus/360photos/
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360basicraymarching\x360basicraymarching\bin\Debug\staging\x360basicraymarching.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360basicraymarching\x360basicraymarching\bin\Debug\staging\x360basicraymarching.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360basicraymarching\x360basicraymarching\bin\Debug\staging\x360basicraymarching.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360basicraymarching/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360basicraymarching");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360basicraymarching/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
...
// assembly: V:\x360basicraymarching.Application.exe
// type: CubeToEquirectangular.Library.ShaderToy+<AttachToDocument>d__14+<MoveNext>06000034, x360basicraymarching.Application, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// offset: 0x0154
