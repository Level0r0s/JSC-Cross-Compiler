...
using x360mirrorbox;
using x360mirrorbox.Design;
using x360mirrorbox.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360mirrorbox
{
    using x360mirrorbox.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360mirrorbox\00188.png" /sdcard/oculus/360photos/
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360mirrorbox\x360mirrorbox\bin\Debug\staging\x360mirrorbox.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360mirrorbox\x360mirrorbox\bin\Debug\staging\x360mirrorbox.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360mirrorbox\x360mirrorbox\bin\Debug\staging\x360mirrorbox.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360mirrorbox/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360mirrorbox");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360mirrorbox/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
