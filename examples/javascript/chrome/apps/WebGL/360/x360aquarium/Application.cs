...
using x360aquarium;
using x360aquarium.Design;
using x360aquarium.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360aquarium
{
    //using x360aquarium.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360aquarium\00188.png" /sdcard/oculus/360photos/
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360aquarium\x360aquarium\bin\Debug\staging\x360aquarium.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360aquarium\x360aquarium\bin\Debug\staging\x360aquarium.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360aquarium\x360aquarium\bin\Debug\staging\x360aquarium.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360aquarium/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360aquarium");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360aquarium/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
