...
using x360dual;
using x360dual.Design;
using x360dual.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360dual
{
    using x360dual.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360dual\x360dual\bin\Debug\staging\x360dual.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360dual\x360dual\bin\Debug\staging\x360dual.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360dual\x360dual\bin\Debug\staging\x360dual.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360dual/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360dual");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360dual/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
            ...
            var frameIDslider = new IHTMLInput { type = ScriptCoreLib.Shared.HTMLInputTypeEnum.range, min = 0, max = maxframes, valueAsNumber = maxframes / 2, title = "frameIDslider" }.AttachToDocument();
...

            {
                ...
                var planeGeometry0 = new THREE.PlaneGeometry(cubefacesize * 120 / 90, cubefacesize * 120 / 90, 8, 8);
                var floor2 = new THREE.Mesh(planeGeometry0,
                    //new THREE.MeshPhongMaterial(new { ambient = 0x101010, color = 0xA26D41, specular = 0xA26D41, shininess = 1 })
                    //new THREE.MeshPhongMaterial(new { ambient = 0x101010, color = 0xff0000, specular = 0xA26D41, shininess = 1 })
                    //new THREE.MeshPhongMaterial(new { ambient = 0xff0000, color = 0xff0000, specular = 0xff0000 })
