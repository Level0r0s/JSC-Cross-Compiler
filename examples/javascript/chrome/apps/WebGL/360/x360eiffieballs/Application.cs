...
using x360eiffieballs;
using x360eiffieballs.Design;
using x360eiffieballs.HTML.Pages;
using System.Diagnostics;
using ScriptCoreLib.JavaScript.WebGL;

namespace x360eiffieballs
{
    using x360eiffieballs.HTML.Images.FromAssets;
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        // R:\util\android-sdk-windows\platform-tools\adb.exe push "P:\vr\x360eiffieballs\00188.png" /sdcard/oculus/360photos/
        ...
        //  "x:\util\android-sdk-windows\platform-tools\adb.exe" push    "X:\vr\mirrorbox.png" "/sdcard/oculus/360photos/"
        //
        ...
        // subst /D b:
        // subst b: s:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360eiffieballs\x360eiffieballs\bin\Debug\staging\x360eiffieballs.Application\web
        // subst a: z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360eiffieballs\x360eiffieballs\bin\Debug\staging\x360eiffieballs.Application\web
        // Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\x360eiffieballs\x360eiffieballs\bin\Debug\staging\x360eiffieballs.Application\web
        // what if we want to do subst in another winstat or session?

        // ColladaLoader: Empty or non-existing file (assets/x360eiffieballs/S6Edge.dae)
        ...
        public Application(IApp page)
        {
            ...
            if (self_chrome_socket != null)
            {
                ...
                else
                {
                    ...
                    chrome.app.runtime.Launched += async delegate
                    {
                        ...
                        new chrome.Notification(title: "x360eiffieballs");
            ...
            // THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter is set to THREE.LinearFilter or THREE.NearestFilter. ( chrome-extension://aemlnmcokphbneegoefdckonejmknohh/assets/x360eiffieballs/anvil___spherical_hdri_panorama_skybox_by_macsix_d6vv4hs.jpg )
            ...
            var vs0 = new ChromeShaderToyEiffieBallsByEiffie.Shaders.Program360FragmentShader();
