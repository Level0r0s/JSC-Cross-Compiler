...
using AtlantisByDr2;
using AtlantisByDr2.Design;
using AtlantisByDr2.HTML.Pages;

namespace AtlantisByDr2
{
    /// <summary>
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        {
            // https://www.shadertoy.com/view/4tXGDH
...
//..................{ Location =
// assembly: Y:\AtlantisByDr2.Application\WebGL ShaderToy.dll
...
// assembly: Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\synergy\AtlantisByDr2\AtlantisByDr2\bin\Debug\AtlantisByDr2.exe
// type: AtlantisByDr2.Application, AtlantisByDr2, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// offset: 0x0146
//  method:Void.ctor(AtlantisByDr2.HTML.Pages.IApp), ex = System.MissingMethodException: Method not found: 'Void ScriptCoreLib.JavaScript.WebGL.WebGLRenderingContext.bindBuffer(UInt32, ScriptCoreLib.JavaScript.WebGL.WebGLBuffer)'.
