...
using XyptonjtrozByNimitz;
using XyptonjtrozByNimitz.Design;
using XyptonjtrozByNimitz.HTML.Pages;

namespace XyptonjtrozByNimitz
{
    /// <summary>
...
//..................{ Location =
// assembly: Y:\XyptonjtrozByNimitz.Application\WebGL ShaderToy.dll
...
// assembly: Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\synergy\XyptonjtrozByNimitz\XyptonjtrozByNimitz\bin\Debug\XyptonjtrozByNimitz.exe
// type: XyptonjtrozByNimitz.Application, XyptonjtrozByNimitz, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// offset: 0x0146
//  method:Void.ctor(XyptonjtrozByNimitz.HTML.Pages.IApp), ex = System.MissingMethodException: Method not found: 'Void ScriptCoreLib.JavaScript.WebGL.WebGLRenderingContext.bindBuffer(UInt32, ScriptCoreLib.JavaScript.WebGL.WebGLBuffer)'.
