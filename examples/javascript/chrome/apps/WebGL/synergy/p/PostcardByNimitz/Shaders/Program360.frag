...
{	
	...
	// first lets add 360 rotation then remove the edges.


	// we had top and bottop switched. and yes bottom looks weird.
	// cannot rotate straight down?
		mat3 camRotate = 
