...
using DottedGridByMacint;
using DottedGridByMacint.Design;
using DottedGridByMacint.HTML.Pages;

namespace DottedGridByMacint
{
    /// <summary>
    ...
    public sealed class Application : ApplicationWebService
    {
        ...
        {
            // https://www.shadertoy.com/view/MlSXRd
