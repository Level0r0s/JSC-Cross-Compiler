...
using LivingMarbleByDiviaki;
using LivingMarbleByDiviaki.Design;
using LivingMarbleByDiviaki.HTML.Pages;

namespace LivingMarbleByDiviaki
{
    /// <summary>
...
//..................{ Location =
// assembly: Y:\LivingMarbleByDiviaki.Application\WebGL ShaderToy.dll
...
// assembly: Z:\jsc.svn\examples\javascript\chrome\apps\WebGL\synergy\LivingMarbleByDiviaki\LivingMarbleByDiviaki\bin\Debug\LivingMarbleByDiviaki.exe
// type: LivingMarbleByDiviaki.Application, LivingMarbleByDiviaki, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null
// offset: 0x0146
//  method:Void.ctor(LivingMarbleByDiviaki.HTML.Pages.IApp), ex = System.MissingMethodException: Method not found: 'Void ScriptCoreLib.JavaScript.WebGL.WebGLRenderingContext.bindBuffer(UInt32, ScriptCoreLib.JavaScript.WebGL.WebGLBuffer)'.
