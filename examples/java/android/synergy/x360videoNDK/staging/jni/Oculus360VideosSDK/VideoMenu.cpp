...
//==============================
// OvrVideoMenu
OvrVideoMenu * OvrVideoMenu::Create( OvrGuiSys & guiSys, OvrMetaData & metaData, float fadeOutTime, float radius )
{
	return new OvrVideoMenu( guiSys, metaData, fadeOutTime, radius );
}

OvrVideoMenu::OvrVideoMenu( OvrGuiSys & guiSys, OvrMetaData & metaData, float fadeOutTime, float radius )
	: VRMenu( MENU_NAME )
	, MetaData( metaData )
	, LoadingIconHandle( 0 )
	, AttributionHandle( 0 )
...
void OvrVideoMenu::Frame_Impl( OvrGuiSys & guiSys, VrFrame const & vrFrame )
{
...
void OvrVideoMenu::OnItemEvent_Impl( OvrGuiSys & guiSys, VRMenuId_t const itemId, VRMenuEvent const & event )
{
