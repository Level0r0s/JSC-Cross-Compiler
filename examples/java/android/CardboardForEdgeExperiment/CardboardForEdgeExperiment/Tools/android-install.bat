...
"x:\util\android-sdk-windows\platform-tools\adb.exe" install -r "X:\util\ChromeShell_Cardboard_SDK_0.5.3.apk"
"x:\util\android-sdk-windows\platform-tools\adb.exe" install -r "X:\util\fennec-40.0a1.multi.android-arm.apk"
