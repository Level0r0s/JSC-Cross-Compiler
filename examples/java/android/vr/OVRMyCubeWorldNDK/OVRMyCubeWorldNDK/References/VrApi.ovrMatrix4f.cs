...
namespace OVRMyCubeWorldNDK
{
    ...
    public unsafe struct ovrMatrix4f //: VrApi_h
    {
        ...
        // Error	3	'OVRMyCubeWorldNDK.ovrMatrix4f.M': cannot have instance field initializers in structs	X:\jsc.svn\examples\java\android\vr\OVRMyCubeWorldNDK\OVRMyCubeWorldNDK\References\VrApi.ovrMatrix4f.cs	61	34	OVRMyCubeWorldNDK
    ...
    public unsafe class __ovrMatrix4f
    {
        ...
        {
            // Error	3	Cannot take the address of, get the size of, or declare a pointer to a managed type ('float[*,*]')	X:\jsc.svn\examples\java\android\vr\OVRMyCubeWorldNDK\OVRMyCubeWorldNDK\References\VrApi.ovrMatrix4f.cs	142	40	OVRMyCubeWorldNDK
