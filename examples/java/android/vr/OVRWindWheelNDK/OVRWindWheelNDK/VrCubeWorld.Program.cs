    ...
    public static unsafe partial class VrCubeWorld
    {
        ...
        public class ovrProgram
        {
            ...
            //public bool ovrProgram_Create(VertexShader vert, FragmentShader frag)
            {
                ...
                if (r == gl3.GL_FALSE)
                {
                    //I/xNativeActivity( 9698): x:\jsc.svn\examples\java\android\synergy\OVRVrCubeWorldSurfaceView\OVRWindWheelNDK\VrCubeWorld.Program.cs:104 ovrProgram_Create VertexShader GL_COMPILE_STATUS  0 errno: 0 Success
                    //I/xNativeActivity( 9698): x:\jsc.svn\examples\java\android\synergy\OVRVrCubeWorldSurfaceView\OVRWindWheelNDK\VrCubeWorld.Program.cs:111 0:12: L0001: Typename expected, found ';'
                ...
                // I/xNativeActivity( 6203): x:\jsc.svn\examples\java\android\synergy\OVRVrCubeWorldSurfaceView\OVRWindWheelNDK\VrCubeWorld.Program.cs:121 ovrProgram_Create FragmentShader GL_COMPILE_STATUS  1 errno: 0 Success
