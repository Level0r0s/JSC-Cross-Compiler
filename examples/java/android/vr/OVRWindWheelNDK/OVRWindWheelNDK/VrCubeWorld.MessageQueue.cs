...
namespace OVRWindWheelNDK
{
    ...
    {
        // X:\jsc.svn\examples\java\android\vr\OVRWindWheelNDK\OVRWindWheelNDK\VrCubeWorld.MessageQueue.cs
    ...
    public static unsafe partial class VrCubeWorld
    {
        ...
        public struct ovrMessage
        {
            ...
            // Error	5	Type 'OVRWindWheelNDK.VrCubeWorld.ovrMessage' already defines a member called 'this' with the same parameter types	X:\jsc.svn\examples\java\android\synergy\OVRVrCubeWorldSurfaceView\OVRWindWheelNDK\VrCubeWorld.MessageQueue.cs	103	26	OVRWindWheelNDK
            ...
            {
                //jni/OVRWindWheelNDK.dll.c: In function 'OVRVrCubeWorldSurfaceViewXNDK_VrCubeWorld_ovrMessage_ovrMessage_SetFloatParm':
                //jni/OVRWindWheelNDK.dll.c:221:22: error: incompatible types when assigning to type 'void *' from type 'float'
